...
export TOOLCHAIN_BASE_DIR=/work/orangePi/OrangePi_H5SDK/toolchain/gcc-linaro-aarch
export CROSS_COMPILE=$TOOLCHAIN_BASE_DIR/bin/aarch64-linux-gnu-
#export CROSS_INCLUDE=$TOOLCHAIN_BASE_DIR/lib/powerpc-fsl-linux/gcc/powerpc-fsl-linux/4.8.2/include
