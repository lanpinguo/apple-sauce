...
/**
 * Create a new of_list_bsn_gentable_bucket_stats_entry object
 *
...
/**
 * Initialize an object of type of_list_bsn_gentable_bucket_stats_entry.
 *
...
void
of_list_bsn_gentable_bucket_stats_entry_init(of_list_bsn_gentable_bucket_stats_entry_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY] >= 0);
    if (clean_wire) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY;
...
int
of_list_bsn_gentable_bucket_stats_entry_first(of_list_bsn_gentable_bucket_stats_entry_t *list,
    of_bsn_gentable_bucket_stats_entry_t *obj)
{
    int rv;

    of_bsn_gentable_bucket_stats_entry_init(obj,
            list->version, 0, 1);
    if ((rv = of_list_first((of_object_t *)list, (of_object_t *)obj)) < 0) {
        return rv;
    }

    of_object_wire_init((of_object_t *) obj, OF_BSN_GENTABLE_BUCKET_STATS_ENTRY,
                        list->length);
    if (obj->length == 0) {
...
int
of_list_bsn_gentable_bucket_stats_entry_next(of_list_bsn_gentable_bucket_stats_entry_t *list,
    of_bsn_gentable_bucket_stats_entry_t *obj)
{
    int rv;
    ...
    rv = of_object_wire_init((of_object_t *) obj, OF_BSN_GENTABLE_BUCKET_STATS_ENTRY,
        list->length);
...
/**
 * Set up to append an object of type of_bsn_gentable_bucket_stats_entry to an of_list_bsn_gentable_bucket_stats_entry.
...
int
of_list_bsn_gentable_bucket_stats_entry_append_bind(of_list_bsn_gentable_bucket_stats_entry_t *list,
    of_bsn_gentable_bucket_stats_entry_t *obj)
{
...
/**
 * Append an item to a of_list_bsn_gentable_bucket_stats_entry list.
 *
...
int
of_list_bsn_gentable_bucket_stats_entry_append(of_list_bsn_gentable_bucket_stats_entry_t *list,
    of_bsn_gentable_bucket_stats_entry_t *item)
{
