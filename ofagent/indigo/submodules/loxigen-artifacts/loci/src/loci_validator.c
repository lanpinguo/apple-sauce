...
static inline int of_oxm_tunnel_id_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_tunnel_id_OF_VERSION_1_2_validate(uint8_t *buf, int len);
...
static inline int of_oxm_mpls_bos_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_mpls_bos_OF_VERSION_1_2_validate(uint8_t *buf, int len);
...
static inline int of_oxm_bsn_udf7_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf7_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf6_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf6_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf5_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf5_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf4_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf4_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf3_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf3_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf2_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf2_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf1_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf1_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf0_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf0_OF_VERSION_1_2_validate(uint8_t *buf, int len);
...
static inline int of_oxm_bsn_egr_port_group_id_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_egr_port_group_id_OF_VERSION_1_2_validate(uint8_t *buf, int len);
...
static inline int onf_oxm_packet_regs3_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int onf_oxm_packet_regs2_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int onf_oxm_packet_regs1_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int onf_oxm_packet_regs0_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofp_queue_desc_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_oxm_tunnel_id_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_tunnel_id_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_oxm_onf_actset_output_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_vrf_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_txfcl_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_traffic_class_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_rxfcl_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_rx_timestamp_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_qos_index_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_protection_index_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_ovid_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_oam_y1731_opcode_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_oam_y1731_mdl_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_mpls_type_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_mpls_ttl_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_mpls_next_label_is_gal_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_mpls_l2_port_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_mpls_l2_port_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_mpls_data_first_nibble_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_mpls_ach_channel_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_lmep_id_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_l3_in_port_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_dei_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_color_actions_index_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_color_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_allow_vlan_translation_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_oxm_mpls_bos_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_mpls_bos_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_oxm_bsn_udf7_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf7_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf6_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf6_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf5_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf5_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf4_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf4_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf3_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf3_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf2_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf2_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf1_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf1_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf0_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_udf0_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_oxm_bsn_egr_port_group_id_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_bsn_egr_port_group_id_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_meter_band_ofdpa_color_set_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_bsn_tlv_udf_length_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_bsn_tlv_udf_id_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_bsn_tlv_udf_anchor_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_action_onf_copy_field_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_onf_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_set_pcpdei_from_table_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_set_mpls_tc_from_vpn_table_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_set_mpls_tc_from_tunnel_table_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_set_mpls_pcpdei_from_tunnel_table_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_set_mpls_pcpdei_from_table_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_set_counter_fields_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_push_l2hdr_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_push_cw_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_pop_l2hdr_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_pop_cw_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_oam_lm_tx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_oam_lm_rx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_dec_ttl_mtu_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_copy_tc_out_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_copy_tc_in_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_color_based_count_3_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_color_based_count_2_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_color_based_count_1_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_color_based_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_class_based_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_check_drop_status_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_action_id_onf_copy_field_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_onf_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_set_pcpdei_from_table_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_set_mpls_tc_from_vpn_table_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_set_mpls_tc_from_tunnel_table_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_set_mpls_pcpdei_from_tunnel_table_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_set_mpls_pcpdei_from_table_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_set_counter_fields_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_push_l2hdr_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_push_cw_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_pop_l2hdr_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_pop_cw_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_oam_lm_tx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_oam_lm_rx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_dec_ttl_mtu_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_copy_tc_out_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_copy_tc_in_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_color_based_count_3_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_color_based_count_2_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_color_based_count_1_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_color_based_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_class_based_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_check_drop_status_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_ofdpa_scheduler_node_multipart_response_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_scheduler_node_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_scheduler_node_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_queue_mod_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_queue_desc_prop_parent_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_queue_desc_prop_parent_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_queue_desc_prop_congestion_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_queue_desc_prop_congestion_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_port_experimenter_prop_scheduling_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_oam_drop_status_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_oam_drop_status_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_oam_drop_status_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_oam_dataplane_ctr_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_oam_dataplane_ctr_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_oam_dataplane_ctr_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_mpls_vpn_label_remark_action_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_mpls_vpn_label_remark_action_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_mpls_vpn_label_remark_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_mpls_tunnel_label_remark_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_mpls_tunnel_label_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_mpls_tunnel_label_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_l2_interface_remark_action_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_l2_interface_remark_action_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_l2_interface_remark_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_color_based_ctr_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_color_based_ctr_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_color_based_ctr_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_class_based_ctr_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_class_based_ctr_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_ofdpa_class_based_ctr_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_meter_modify_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_meter_delete_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_meter_add_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_experimenter_ofdpa_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_experimenter_multipart_request_ofdpa_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_experimenter_multipart_reply_ofdpa_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int
of_oxm_tunnel_id_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 20) {
        VALIDATOR_LOG("Class of_oxm_tunnel_id_masked.  Len %d too small, < %d", len, 20);
        return -1;
    }
...
static inline int
of_oxm_tunnel_id_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_tunnel_id.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_mpls_bos_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 6) {
        VALIDATOR_LOG("Class of_oxm_mpls_bos_masked.  Len %d too small, < %d", len, 6);
        return -1;
    }
...
static inline int
of_oxm_mpls_bos_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 5) {
        VALIDATOR_LOG("Class of_oxm_mpls_bos.  Len %d too small, < %d", len, 5);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf7_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf7_masked.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf7_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf7.  Len %d too small, < %d", len, 8);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf6_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf6_masked.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf6_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf6.  Len %d too small, < %d", len, 8);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf5_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf5_masked.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf5_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf5.  Len %d too small, < %d", len, 8);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf4_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf4_masked.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf4_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf4.  Len %d too small, < %d", len, 8);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf3_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf3_masked.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf3_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf3.  Len %d too small, < %d", len, 8);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf2_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf2_masked.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf2_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf2.  Len %d too small, < %d", len, 8);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf1_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf1_masked.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf1_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf1.  Len %d too small, < %d", len, 8);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf0_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf0_masked.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_bsn_udf0_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf0.  Len %d too small, < %d", len, 8);
        return -1;
    }
...
static inline int
of_oxm_bsn_egr_port_group_id_masked_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_egr_port_group_id_masked.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_bsn_egr_port_group_id_OF_VERSION_1_2_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_egr_port_group_id.  Len %d too small, < %d", len, 8);
        return -1;
    }
...
of_list_meter_band_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    while (len >= 4) {
        ...
        case OF_METER_BAND_OFDPA_COLOR_SET:
            if (of_meter_band_ofdpa_color_set_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        default:
...
of_list_instruction_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    while (len >= 4) {
        ...
        case OF_INSTRUCTION_BSN_ARP_OFFLOAD:
            if (of_instruction_bsn_arp_offload_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK:
            if (of_instruction_bsn_disable_split_horizon_check_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_INSTRUCTION_GOTO_TABLE:
...
of_list_bsn_tlv_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    while (len >= 4) {
        ...
        case OF_BSN_TLV_UDF_LENGTH:
            if (of_bsn_tlv_udf_length_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_BSN_TLV_UDF_ID:
            if (of_bsn_tlv_udf_id_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_BSN_TLV_UDF_OFFSET:
            if (of_bsn_tlv_udf_offset_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
...
of_list_action_id_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    while (len >= 4) {
        ...
        switch (e_id) {
        case OF_ACTION_ID_OFDPA_SET_PCPDEI_FROM_TABLE:
            if (of_action_id_ofdpa_set_pcpdei_from_table_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_ID_BSN_MIRROR:
            ...
            break;
        case OF_ACTION_ID_ONF:
            if (of_action_id_onf_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OFDPA_PUSH_CW:
            if (of_action_id_ofdpa_push_cw_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OFDPA_COPY_TC_IN:
            if (of_action_id_ofdpa_copy_tc_in_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OFDPA_DEC_TTL_MTU:
            if (of_action_id_ofdpa_dec_ttl_mtu_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_ID_BSN_SET_TUNNEL_DST:
            ...
            break;
        case OF_ACTION_ID_OFDPA_OAM_LM_TX_COUNT:
            if (of_action_id_ofdpa_oam_lm_tx_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OFDPA_COPY_TC_OUT:
            if (of_action_id_ofdpa_copy_tc_out_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_ID_GROUP:
            ...
            break;
        case OF_ACTION_ID_OFDPA_PUSH_L2HDR:
            if (of_action_id_ofdpa_push_l2hdr_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OFDPA_SET_COUNTER_FIELDS:
            if (of_action_id_ofdpa_set_counter_fields_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OFDPA_CHECK_DROP_STATUS:
            if (of_action_id_ofdpa_check_drop_status_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_ID_POP_VLAN:
            ...
            break;
        case OF_ACTION_ID_OFDPA_SET_MPLS_TC_FROM_VPN_TABLE:
            if (of_action_id_ofdpa_set_mpls_tc_from_vpn_table_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OFDPA_POP_CW:
            if (of_action_id_ofdpa_pop_cw_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_ID_NICIRA_DEC_TTL:
            ...
            break;
        case OF_ACTION_ID_OFDPA_OAM_LM_RX_COUNT:
            if (of_action_id_ofdpa_oam_lm_rx_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OFDPA_COLOR_BASED_COUNT:
            if (of_action_id_ofdpa_color_based_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_ID_PUSH_VLAN:
            ...
            break;
        case OF_ACTION_ID_OFDPA_COLOR_BASED_COUNT_3:
            if (of_action_id_ofdpa_color_based_count_3_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OFDPA_SET_MPLS_PCPDEI_FROM_TABLE:
            if (of_action_id_ofdpa_set_mpls_pcpdei_from_table_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_ID_EXPERIMENTER:
            ...
            break;
        case OF_ACTION_ID_OFDPA_SET_MPLS_TC_FROM_TUNNEL_TABLE:
            if (of_action_id_ofdpa_set_mpls_tc_from_tunnel_table_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OFDPA:
            if (of_action_id_ofdpa_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_SET_NW_TTL:
            ...
            break;
        case OF_ACTION_ID_OFDPA_COLOR_BASED_COUNT_2:
            if (of_action_id_ofdpa_color_based_count_2_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_ID_NICIRA:
            ...
            break;
        case OF_ACTION_ID_OFDPA_POP_L2HDR:
            if (of_action_id_ofdpa_pop_l2hdr_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OFDPA_COLOR_BASED_COUNT_1:
            if (of_action_id_ofdpa_color_based_count_1_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_ID_DEC_NW_TTL:
            ...
            break;
        case OF_ACTION_ID_ONF_COPY_FIELD:
            if (of_action_id_onf_copy_field_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OFDPA_SET_MPLS_PCPDEI_FROM_TUNNEL_TABLE:
            if (of_action_id_ofdpa_set_mpls_pcpdei_from_tunnel_table_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_OUTPUT:
            ...
            break;
        case OF_ACTION_ID_OFDPA_CLASS_BASED_COUNT:
            if (of_action_id_ofdpa_class_based_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        default:
...
of_list_action_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    while (len >= 8) {
        ...
        case OF_ACTION_OFDPA_SET_PCPDEI_FROM_TABLE:
            if (of_action_ofdpa_set_pcpdei_from_table_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_COPY_TTL_OUT:
        ...
        case OF_ACTION_SET_FIELD:
            ...
            break;
        case OF_ACTION_ONF:
            if (of_action_onf_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_OFDPA_PUSH_CW:
            if (of_action_ofdpa_push_cw_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_OFDPA_COPY_TC_IN:
            if (of_action_ofdpa_copy_tc_in_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_OFDPA_DEC_TTL_MTU:
            if (of_action_ofdpa_dec_ttl_mtu_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_DEC_MPLS_TTL:
        ...
        case OF_ACTION_OFDPA_COPY_TC_OUT:
            if (of_action_ofdpa_copy_tc_out_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_OFDPA_PUSH_L2HDR:
            if (of_action_ofdpa_push_l2hdr_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_OFDPA_OAM_LM_TX_COUNT:
            if (of_action_ofdpa_oam_lm_tx_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_SET_MPLS_TTL:
        ...
        case OF_ACTION_OFDPA_SET_COUNTER_FIELDS:
            if (of_action_ofdpa_set_counter_fields_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_OFDPA_SET_MPLS_TC_FROM_VPN_TABLE:
            if (of_action_ofdpa_set_mpls_tc_from_vpn_table_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_OFDPA_POP_CW:
            if (of_action_ofdpa_pop_cw_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_OFDPA_OAM_LM_RX_COUNT:
            if (of_action_ofdpa_oam_lm_rx_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_POP_MPLS:
        ...
        case OF_ACTION_ONF_COPY_FIELD:
            if (of_action_onf_copy_field_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_OFDPA_COLOR_BASED_COUNT_3:
            if (of_action_ofdpa_color_based_count_3_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_OFDPA_SET_MPLS_PCPDEI_FROM_TABLE:
            if (of_action_ofdpa_set_mpls_pcpdei_from_table_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_BSN:
        ...
        case OF_ACTION_OFDPA_SET_MPLS_TC_FROM_TUNNEL_TABLE:
            if (of_action_ofdpa_set_mpls_tc_from_tunnel_table_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_OFDPA:
            if (of_action_ofdpa_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_SET_NW_TTL:
        ...
        case OF_ACTION_OFDPA_COLOR_BASED_COUNT_2:
            if (of_action_ofdpa_color_based_count_2_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_COPY_TTL_IN:
        ...
        case OF_ACTION_OFDPA_POP_L2HDR:
            if (of_action_ofdpa_pop_l2hdr_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_OFDPA_COLOR_BASED_COUNT_1:
            if (of_action_ofdpa_color_based_count_1_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_PUSH_MPLS:
        ...
        case OF_ACTION_OFDPA_CHECK_DROP_STATUS:
            if (of_action_ofdpa_check_drop_status_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_SET_QUEUE:
        ...
        case OF_ACTION_OFDPA_SET_MPLS_PCPDEI_FROM_TUNNEL_TABLE:
            if (of_action_ofdpa_set_mpls_pcpdei_from_tunnel_table_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_OUTPUT:
        ...
        case OF_ACTION_OFDPA_CLASS_BASED_COUNT:
            if (of_action_ofdpa_class_based_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_OFDPA_COLOR_BASED_COUNT:
            if (of_action_ofdpa_color_based_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        default:
...
static inline int
onf_oxm_packet_regs3_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class onf_oxm_packet_regs3.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
onf_oxm_packet_regs2_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class onf_oxm_packet_regs2.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
onf_oxm_packet_regs1_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class onf_oxm_packet_regs1.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
onf_oxm_packet_regs0_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class onf_oxm_packet_regs0.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
ofp_queue_desc_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class ofp_queue_desc.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_oxm_tunnel_id_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 20) {
        VALIDATOR_LOG("Class of_oxm_tunnel_id_masked.  Len %d too small, < %d", len, 20);
        return -1;
...
static inline int
of_oxm_tunnel_id_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_tunnel_id.  Len %d too small, < %d", len, 12);
        return -1;
...
static inline int
of_oxm_onf_actset_output_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_onf_actset_output.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_vrf_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_vrf.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_txfcl_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_txfcl.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_traffic_class_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 9) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_traffic_class.  Len %d too small, < %d", len, 9);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_rxfcl_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_rxfcl.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_rx_timestamp_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_rx_timestamp.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_qos_index_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 9) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_qos_index.  Len %d too small, < %d", len, 9);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_protection_index_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 9) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_protection_index.  Len %d too small, < %d", len, 9);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_ovid_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_ovid.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_oam_y1731_opcode_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 9) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_oam_y1731_opcode.  Len %d too small, < %d", len, 9);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_oam_y1731_mdl_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 9) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_oam_y1731_mdl.  Len %d too small, < %d", len, 9);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_mpls_type_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_mpls_type.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_mpls_ttl_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 9) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_mpls_ttl.  Len %d too small, < %d", len, 9);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_mpls_next_label_is_gal_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 9) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_mpls_next_label_is_gal.  Len %d too small, < %d", len, 9);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_mpls_l2_port_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_mpls_l2_port_masked.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_mpls_l2_port_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_mpls_l2_port.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_mpls_data_first_nibble_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 9) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_mpls_data_first_nibble.  Len %d too small, < %d", len, 9);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_mpls_ach_channel_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_mpls_ach_channel.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_lmep_id_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_lmep_id.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_l3_in_port_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_l3_in_port.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_dei_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 9) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_dei.  Len %d too small, < %d", len, 9);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_color_actions_index_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_color_actions_index.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_color_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 9) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_color.  Len %d too small, < %d", len, 9);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_allow_vlan_translation_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 9) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_allow_vlan_translation.  Len %d too small, < %d", len, 9);
        return -1;
    }
...
static inline int
of_oxm_mpls_bos_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 6) {
        VALIDATOR_LOG("Class of_oxm_mpls_bos_masked.  Len %d too small, < %d", len, 6);
        return -1;
...
static inline int
of_oxm_mpls_bos_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 5) {
        VALIDATOR_LOG("Class of_oxm_mpls_bos.  Len %d too small, < %d", len, 5);
        return -1;
...
static inline int
of_oxm_bsn_udf7_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf7_masked.  Len %d too small, < %d", len, 12);
        return -1;
...
static inline int
of_oxm_bsn_udf7_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf7.  Len %d too small, < %d", len, 8);
        return -1;
...
static inline int
of_oxm_bsn_udf6_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf6_masked.  Len %d too small, < %d", len, 12);
        return -1;
...
static inline int
of_oxm_bsn_udf6_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf6.  Len %d too small, < %d", len, 8);
        return -1;
...
static inline int
of_oxm_bsn_udf5_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf5_masked.  Len %d too small, < %d", len, 12);
        return -1;
...
static inline int
of_oxm_bsn_udf5_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf5.  Len %d too small, < %d", len, 8);
        return -1;
...
static inline int
of_oxm_bsn_udf4_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf4_masked.  Len %d too small, < %d", len, 12);
        return -1;
...
static inline int
of_oxm_bsn_udf4_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf4.  Len %d too small, < %d", len, 8);
        return -1;
...
static inline int
of_oxm_bsn_udf3_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf3_masked.  Len %d too small, < %d", len, 12);
        return -1;
...
static inline int
of_oxm_bsn_udf3_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf3.  Len %d too small, < %d", len, 8);
        return -1;
...
static inline int
of_oxm_bsn_udf2_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf2_masked.  Len %d too small, < %d", len, 12);
        return -1;
...
static inline int
of_oxm_bsn_udf2_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf2.  Len %d too small, < %d", len, 8);
        return -1;
...
static inline int
of_oxm_bsn_udf1_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf1_masked.  Len %d too small, < %d", len, 12);
        return -1;
...
static inline int
of_oxm_bsn_udf1_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf1.  Len %d too small, < %d", len, 8);
        return -1;
...
static inline int
of_oxm_bsn_udf0_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf0_masked.  Len %d too small, < %d", len, 12);
        return -1;
...
static inline int
of_oxm_bsn_udf0_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_udf0.  Len %d too small, < %d", len, 8);
        return -1;
...
static inline int
of_oxm_bsn_egr_port_group_id_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_bsn_egr_port_group_id_masked.  Len %d too small, < %d", len, 12);
        return -1;
...
static inline int
of_oxm_bsn_egr_port_group_id_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 8) {
        VALIDATOR_LOG("Class of_oxm_bsn_egr_port_group_id.  Len %d too small, < %d", len, 8);
        return -1;
...
static inline int
of_meter_band_ofdpa_color_set_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 24) {
        VALIDATOR_LOG("Class of_meter_band_ofdpa_color_set.  Len %d too small, < %d", len, 24);
        return -1;
    }
...
static inline int
of_instruction_bsn_disable_split_horizon_check_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_instruction_bsn_disable_split_horizon_check.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_instruction_bsn_arp_offload_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_instruction_bsn_arp_offload.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_bsn_tlv_udf_offset_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 6) {
        VALIDATOR_LOG("Class of_bsn_tlv_udf_offset.  Len %d too small, < %d", len, 6);
        return -1;
    }
...
static inline int
of_bsn_tlv_udf_length_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 6) {
        VALIDATOR_LOG("Class of_bsn_tlv_udf_length.  Len %d too small, < %d", len, 6);
        return -1;
    }
...
static inline int
of_bsn_tlv_udf_id_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 6) {
        VALIDATOR_LOG("Class of_bsn_tlv_udf_id.  Len %d too small, < %d", len, 6);
        return -1;
    }
...
static inline int
of_bsn_tlv_udf_anchor_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 6) {
        VALIDATOR_LOG("Class of_bsn_tlv_udf_anchor.  Len %d too small, < %d", len, 6);
        return -1;
    }
...
static inline int
of_action_onf_copy_field_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 20) {
        VALIDATOR_LOG("Class of_action_onf_copy_field.  Len %d too small, < %d", len, 20);
        return -1;
    }
...
static inline int
of_action_onf_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_onf.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_set_pcpdei_from_table_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_set_pcpdei_from_table.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_set_mpls_tc_from_vpn_table_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_set_mpls_tc_from_vpn_table.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_set_mpls_tc_from_tunnel_table_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_set_mpls_tc_from_tunnel_table.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_set_mpls_pcpdei_from_tunnel_table_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_set_mpls_pcpdei_from_tunnel_table.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_set_mpls_pcpdei_from_table_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_set_mpls_pcpdei_from_table.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_set_counter_fields_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_set_counter_fields.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_push_l2hdr_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_push_l2hdr.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_push_cw_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_push_cw.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_pop_l2hdr_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_pop_l2hdr.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_pop_cw_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_pop_cw.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_oam_lm_tx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_oam_lm_tx_count.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_oam_lm_rx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_oam_lm_rx_count.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_dec_ttl_mtu_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_dec_ttl_mtu.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_copy_tc_out_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_copy_tc_out.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_copy_tc_in_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_copy_tc_in.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_color_based_count_3_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_color_based_count_3.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_color_based_count_2_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_color_based_count_2.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_color_based_count_1_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_color_based_count_1.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_color_based_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_color_based_count.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_class_based_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_class_based_count.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_check_drop_status_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_check_drop_status.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_id_onf_copy_field_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_onf_copy_field.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_onf_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_onf.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_set_pcpdei_from_table_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_set_pcpdei_from_table.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_set_mpls_tc_from_vpn_table_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_set_mpls_tc_from_vpn_table.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_set_mpls_tc_from_tunnel_table_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_set_mpls_tc_from_tunnel_table.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_set_mpls_pcpdei_from_tunnel_table_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_set_mpls_pcpdei_from_tunnel_table.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_set_mpls_pcpdei_from_table_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_set_mpls_pcpdei_from_table.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_set_counter_fields_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_set_counter_fields.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_push_l2hdr_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_push_l2hdr.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_push_cw_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_push_cw.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_pop_l2hdr_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_pop_l2hdr.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_pop_cw_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_pop_cw.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_oam_lm_tx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_oam_lm_tx_count.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_oam_lm_rx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_oam_lm_rx_count.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_dec_ttl_mtu_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_dec_ttl_mtu.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_copy_tc_out_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_copy_tc_out.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_copy_tc_in_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_copy_tc_in.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_color_based_count_3_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_color_based_count_3.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_color_based_count_2_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_color_based_count_2.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_color_based_count_1_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_color_based_count_1.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_color_based_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_color_based_count.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_class_based_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_class_based_count.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_check_drop_status_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_check_drop_status.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_ofdpa_scheduler_node_multipart_response_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 40) {
        VALIDATOR_LOG("Class of_ofdpa_scheduler_node_multipart_response.  Len %d too small, < %d", len, 40);
        return -1;
    }
...
static inline int
of_ofdpa_scheduler_node_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 40) {
        VALIDATOR_LOG("Class of_ofdpa_scheduler_node_multipart_request.  Len %d too small, < %d", len, 40);
        return -1;
    }
...
static inline int
of_ofdpa_scheduler_node_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 34) {
        VALIDATOR_LOG("Class of_ofdpa_scheduler_node_mod_msg.  Len %d too small, < %d", len, 34);
        return -1;
    }
...
static inline int
of_ofdpa_queue_mod_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 42) {
        VALIDATOR_LOG("Class of_ofdpa_queue_mod.  Len %d too small, < %d", len, 42);
        return -1;
    }
...
static inline int
of_ofdpa_queue_desc_prop_parent_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 28) {
        VALIDATOR_LOG("Class of_ofdpa_queue_desc_prop_parent_multipart_request.  Len %d too small, < %d", len, 28);
        return -1;
    }
...
static inline int
of_ofdpa_queue_desc_prop_parent_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 28) {
        VALIDATOR_LOG("Class of_ofdpa_queue_desc_prop_parent_multipart_reply.  Len %d too small, < %d", len, 28);
        return -1;
    }
...
static inline int
of_ofdpa_queue_desc_prop_congestion_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 28) {
        VALIDATOR_LOG("Class of_ofdpa_queue_desc_prop_congestion_multipart_request.  Len %d too small, < %d", len, 28);
        return -1;
    }
...
static inline int
of_ofdpa_queue_desc_prop_congestion_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 28) {
        VALIDATOR_LOG("Class of_ofdpa_queue_desc_prop_congestion_multipart_reply.  Len %d too small, < %d", len, 28);
        return -1;
    }
...
static inline int
of_ofdpa_port_experimenter_prop_scheduling_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 48) {
        VALIDATOR_LOG("Class of_ofdpa_port_experimenter_prop_scheduling.  Len %d too small, < %d", len, 48);
        return -1;
    }
...
static inline int
of_ofdpa_oam_drop_status_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 35) {
        VALIDATOR_LOG("Class of_ofdpa_oam_drop_status_multipart_request.  Len %d too small, < %d", len, 35);
        return -1;
    }
...
static inline int
of_ofdpa_oam_drop_status_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 31) {
        VALIDATOR_LOG("Class of_ofdpa_oam_drop_status_multipart_reply.  Len %d too small, < %d", len, 31);
        return -1;
    }
...
static inline int
of_ofdpa_oam_drop_status_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 32) {
        VALIDATOR_LOG("Class of_ofdpa_oam_drop_status_mod_msg.  Len %d too small, < %d", len, 32);
        return -1;
    }
...
static inline int
of_ofdpa_oam_dataplane_ctr_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 56) {
        VALIDATOR_LOG("Class of_ofdpa_oam_dataplane_ctr_multipart_request.  Len %d too small, < %d", len, 56);
        return -1;
    }
...
static inline int
of_ofdpa_oam_dataplane_ctr_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 56) {
        VALIDATOR_LOG("Class of_ofdpa_oam_dataplane_ctr_multipart_reply.  Len %d too small, < %d", len, 56);
        return -1;
    }
...
static inline int
of_ofdpa_oam_dataplane_ctr_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 48) {
        VALIDATOR_LOG("Class of_ofdpa_oam_dataplane_ctr_mod_msg.  Len %d too small, < %d", len, 48);
        return -1;
    }
...
static inline int
of_ofdpa_mpls_vpn_label_remark_action_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 39) {
        VALIDATOR_LOG("Class of_ofdpa_mpls_vpn_label_remark_action_multipart_request.  Len %d too small, < %d", len, 39);
        return -1;
    }
...
static inline int
of_ofdpa_mpls_vpn_label_remark_action_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 39) {
        VALIDATOR_LOG("Class of_ofdpa_mpls_vpn_label_remark_action_multipart_reply.  Len %d too small, < %d", len, 39);
        return -1;
    }
...
static inline int
of_ofdpa_mpls_vpn_label_remark_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 32) {
        VALIDATOR_LOG("Class of_ofdpa_mpls_vpn_label_remark_action_mod_msg.  Len %d too small, < %d", len, 32);
        return -1;
    }
...
static inline int
of_ofdpa_mpls_tunnel_label_remark_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 32) {
        VALIDATOR_LOG("Class of_ofdpa_mpls_tunnel_label_remark_action_mod_msg.  Len %d too small, < %d", len, 32);
        return -1;
    }
...
static inline int
of_ofdpa_mpls_tunnel_label_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 39) {
        VALIDATOR_LOG("Class of_ofdpa_mpls_tunnel_label_multipart_request.  Len %d too small, < %d", len, 39);
        return -1;
    }
...
static inline int
of_ofdpa_mpls_tunnel_label_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 39) {
        VALIDATOR_LOG("Class of_ofdpa_mpls_tunnel_label_multipart_reply.  Len %d too small, < %d", len, 39);
        return -1;
    }
...
static inline int
of_ofdpa_l2_interface_remark_action_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 39) {
        VALIDATOR_LOG("Class of_ofdpa_l2_interface_remark_action_multipart_request.  Len %d too small, < %d", len, 39);
        return -1;
    }
...
static inline int
of_ofdpa_l2_interface_remark_action_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 39) {
        VALIDATOR_LOG("Class of_ofdpa_l2_interface_remark_action_multipart_reply.  Len %d too small, < %d", len, 39);
        return -1;
    }
...
static inline int
of_ofdpa_l2_interface_remark_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 32) {
        VALIDATOR_LOG("Class of_ofdpa_l2_interface_remark_action_mod_msg.  Len %d too small, < %d", len, 32);
        return -1;
    }
...
static inline int
of_ofdpa_color_based_ctr_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 32) {
        VALIDATOR_LOG("Class of_ofdpa_color_based_ctr_multipart_request.  Len %d too small, < %d", len, 32);
        return -1;
    }
...
static inline int
of_ofdpa_color_based_ctr_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 64) {
        VALIDATOR_LOG("Class of_ofdpa_color_based_ctr_multipart_reply.  Len %d too small, < %d", len, 64);
        return -1;
    }
...
static inline int
of_ofdpa_color_based_ctr_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 48) {
        VALIDATOR_LOG("Class of_ofdpa_color_based_ctr_mod_msg.  Len %d too small, < %d", len, 48);
        return -1;
    }
...
static inline int
of_ofdpa_class_based_ctr_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 32) {
        VALIDATOR_LOG("Class of_ofdpa_class_based_ctr_multipart_request.  Len %d too small, < %d", len, 32);
        return -1;
    }
...
static inline int
of_ofdpa_class_based_ctr_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 64) {
        VALIDATOR_LOG("Class of_ofdpa_class_based_ctr_multipart_reply.  Len %d too small, < %d", len, 64);
        return -1;
    }
...
static inline int
of_ofdpa_class_based_ctr_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 48) {
        VALIDATOR_LOG("Class of_ofdpa_class_based_ctr_mod_msg.  Len %d too small, < %d", len, 48);
        return -1;
    }
...
static inline int
of_meter_modify_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_meter_modify.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_meter_delete_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_meter_delete.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_meter_add_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_meter_add.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
of_features_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    ...
    {    int ports_len = len - 32;
        ...
        if (of_list_port_desc_OF_VERSION_1_3_validate(buf + 32, ports_len) < 0) {
            return -1;
        }
    }
...
static inline int
of_experimenter_ofdpa_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 20) {
        VALIDATOR_LOG("Class of_experimenter_ofdpa.  Len %d too small, < %d", len, 20);
        return -1;
    }
...
static inline int
of_experimenter_multipart_request_ofdpa_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 24) {
        VALIDATOR_LOG("Class of_experimenter_multipart_request_ofdpa.  Len %d too small, < %d", len, 24);
        return -1;
    }
...
static inline int
of_experimenter_multipart_reply_ofdpa_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 24) {
        VALIDATOR_LOG("Class of_experimenter_multipart_reply_ofdpa.  Len %d too small, < %d", len, 24);
        return -1;
    }
...
of_validate_message_OF_VERSION_1_3(of_message_t msg, int len)
{
    ...
    case OF_OFDPA_SCHEDULER_NODE_MULTIPART_RESPONSE:
        return of_ofdpa_scheduler_node_multipart_response_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_SCHEDULER_NODE_MULTIPART_REQUEST:
        return of_ofdpa_scheduler_node_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_SCHEDULER_NODE_MOD_MSG:
        return of_ofdpa_scheduler_node_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_QUEUE_MOD:
        return of_ofdpa_queue_mod_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_QUEUE_DESC_PROP_PARENT_MULTIPART_REQUEST:
        return of_ofdpa_queue_desc_prop_parent_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_QUEUE_DESC_PROP_PARENT_MULTIPART_REPLY:
        return of_ofdpa_queue_desc_prop_parent_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_QUEUE_DESC_PROP_CONGESTION_MULTIPART_REQUEST:
        return of_ofdpa_queue_desc_prop_congestion_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_QUEUE_DESC_PROP_CONGESTION_MULTIPART_REPLY:
        return of_ofdpa_queue_desc_prop_congestion_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_PORT_EXPERIMENTER_PROP_SCHEDULING:
        return of_ofdpa_port_experimenter_prop_scheduling_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_OAM_DROP_STATUS_MULTIPART_REQUEST:
        return of_ofdpa_oam_drop_status_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_OAM_DROP_STATUS_MULTIPART_REPLY:
        return of_ofdpa_oam_drop_status_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_OAM_DROP_STATUS_MOD_MSG:
        return of_ofdpa_oam_drop_status_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_OAM_DATAPLANE_CTR_MULTIPART_REQUEST:
        return of_ofdpa_oam_dataplane_ctr_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_OAM_DATAPLANE_CTR_MULTIPART_REPLY:
        return of_ofdpa_oam_dataplane_ctr_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_OAM_DATAPLANE_CTR_MOD_MSG:
        return of_ofdpa_oam_dataplane_ctr_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_MPLS_VPN_LABEL_REMARK_ACTION_MULTIPART_REQUEST:
        return of_ofdpa_mpls_vpn_label_remark_action_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_MPLS_VPN_LABEL_REMARK_ACTION_MULTIPART_REPLY:
        return of_ofdpa_mpls_vpn_label_remark_action_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_MPLS_VPN_LABEL_REMARK_ACTION_MOD_MSG:
        return of_ofdpa_mpls_vpn_label_remark_action_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_MPLS_TUNNEL_LABEL_REMARK_ACTION_MOD_MSG:
        return of_ofdpa_mpls_tunnel_label_remark_action_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_MPLS_TUNNEL_LABEL_MULTIPART_REQUEST:
        return of_ofdpa_mpls_tunnel_label_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_MPLS_TUNNEL_LABEL_MULTIPART_REPLY:
        return of_ofdpa_mpls_tunnel_label_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_L2_INTERFACE_REMARK_ACTION_MULTIPART_REQUEST:
        return of_ofdpa_l2_interface_remark_action_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_L2_INTERFACE_REMARK_ACTION_MULTIPART_REPLY:
        return of_ofdpa_l2_interface_remark_action_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_L2_INTERFACE_REMARK_ACTION_MOD_MSG:
        return of_ofdpa_l2_interface_remark_action_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_COLOR_BASED_CTR_MULTIPART_REQUEST:
        return of_ofdpa_color_based_ctr_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_COLOR_BASED_CTR_MULTIPART_REPLY:
        return of_ofdpa_color_based_ctr_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_COLOR_BASED_CTR_MOD_MSG:
        return of_ofdpa_color_based_ctr_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_CLASS_BASED_CTR_MULTIPART_REQUEST:
        return of_ofdpa_class_based_ctr_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_CLASS_BASED_CTR_MULTIPART_REPLY:
        return of_ofdpa_class_based_ctr_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OF_OFDPA_CLASS_BASED_CTR_MOD_MSG:
        return of_ofdpa_class_based_ctr_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OF_NICIRA_HEADER:
    ...
    case OF_METER_MODIFY:
        return of_meter_modify_OF_VERSION_1_3_validate(buf, len);
    ...
    case OF_METER_DELETE:
        return of_meter_delete_OF_VERSION_1_3_validate(buf, len);
    ...
    case OF_METER_ADD:
        return of_meter_add_OF_VERSION_1_3_validate(buf, len);
    case OF_HELLO_FAILED_ERROR_MSG:
    ...
    case OF_EXPERIMENTER_OFDPA:
        return of_experimenter_ofdpa_OF_VERSION_1_3_validate(buf, len);
    case OF_EXPERIMENTER_MULTIPART_REQUEST_OFDPA:
        return of_experimenter_multipart_request_ofdpa_OF_VERSION_1_3_validate(buf, len);
    case OF_EXPERIMENTER_MULTIPART_REPLY_OFDPA:
        return of_experimenter_multipart_reply_ofdpa_OF_VERSION_1_3_validate(buf, len);
    case OF_EXPERIMENTER_ERROR_MSG:
