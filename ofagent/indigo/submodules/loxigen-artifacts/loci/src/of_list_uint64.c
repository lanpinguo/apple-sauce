...
/**
 * \defgroup of_list_uint64 of_list_uint64
 */

/**
 * Create a new of_list_uint64 object
 *
...
of_list_uint64_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_LIST_UINT64] + of_object_extra_len[version][OF_LIST_UINT64];
    ...
    of_list_uint64_init(obj, version, bytes, 0);

    return obj;
}

/**
 * Initialize an object of type of_list_uint64.
 *
...
int
of_list_uint64_first(of_list_uint64_t *list,
    of_uint64_t *obj)
{
    int rv;
    ...
    of_object_wire_init((of_object_t *) obj, OF_UINT64,
                        list->length);
    if (obj->length == 0) {
...
int
of_list_uint64_next(of_list_uint64_t *list,
    of_uint64_t *obj)
{
    int rv;
    ...
    rv = of_object_wire_init((of_object_t *) obj, OF_UINT64,
        list->length);
...
/**
 * Set up to append an object of type of_uint64 to an of_list_uint64.
...
int
of_list_uint64_append_bind(of_list_uint64_t *list,
    of_uint64_t *obj)
{
...
/**
 * Append an item to a of_list_uint64 list.
 *
...
int
of_list_uint64_append(of_list_uint64_t *list,
    of_uint64_t *item)
{
