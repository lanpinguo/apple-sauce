    ...
    case OF_VERSION_1_3: {
        ...
        case 0x13:
            *id = OF_OFDPA_QUEUE_DESC_PROP_CONGESTION_MULTIPART_REPLY;
            break;
        /* Added by JiaoYong, 2017/4/6 设备能力上报EXPERIMENTER_TYPE,私有定义*/
...
/*****************************************************************************
 函 数 名  : of_ofdpa_oam_drop_status_multipart_reply_push_wire_types
 功能描述  : Fill Header
...
/*****************************************************************************
 函 数 名  : of_ofdpa_oam_drop_status_multipart_reply_push_wire_values
 功能描述  : Fill Header
