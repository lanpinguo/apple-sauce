    ...
    of_version_t version, int bytes, int clean_wire)
{
    ...
    obj->wire_type_set = of_bsn_controller_connections_reply_push_wire_types;
    ...
    of_list_bsn_controller_connection_t *connections)
{
    ...
    connections->wire_object.wbuf = obj->wire_object.wbuf;
    connections->wire_object.obj_offset = abs_offset;
    connections->wire_object.owned = 0;
    ...
    of_list_bsn_controller_connection_t *connections)
{
    ...
    if (obj->wire_object.wbuf == connections->wire_object.wbuf) {
    ...
    if (connections->wire_length_set != NULL) {
        connections->wire_length_set((of_object_t *)connections, connections->length);
    }
...
of_bsn_debug_counter_desc_stats_entry_new(of_version_t version)
{
    ...
    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (of_bsn_debug_counter_desc_stats_entry_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }
    ...
    of_version_t version, int bytes, int clean_wire)
{
    ...
    obj->wire_type_set = of_bsn_debug_counter_desc_stats_reply_push_wire_types;
...
of_bsn_debug_counter_desc_stats_request_new(of_version_t version)
{
    ...
    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (of_bsn_debug_counter_desc_stats_request_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }
    ...
    of_version_t version, int bytes, int clean_wire)
{
    ...
    obj->wire_type_set = of_bsn_debug_counter_desc_stats_request_push_wire_types;
...
of_bsn_debug_counter_stats_entry_new(of_version_t version)
{
    ...
    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (of_bsn_debug_counter_stats_entry_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }
    ...
    of_version_t version, int bytes, int clean_wire)
{
    ...
    obj->wire_type_set = of_bsn_debug_counter_stats_reply_push_wire_types;
...
of_bsn_debug_counter_stats_request_new(of_version_t version)
{
    ...
    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (of_bsn_debug_counter_stats_request_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }
    ...
    of_version_t version, int bytes, int clean_wire)
{
    ...
    obj->wire_type_set = of_bsn_debug_counter_stats_request_push_wire_types;
