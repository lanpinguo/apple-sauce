...
#ifdef OFDPA_FIXUP
#define LOCI_SHOW_u8_mpls_bos(writer, cookie, val)                      LOCI_SHOW_x8 (writer, cookie, val)
#define LOCI_SHOW_u64_tunnel_id(writer, cookie, val)                    LOCI_SHOW_x64(writer, cookie, val)
#define LOCI_SHOW_u8_qos_index(writer, cookie, val)                     LOCI_SHOW_x8 (writer, cookie, val)
#define LOCI_SHOW_u16_qos_index(writer, cookie, val)                    LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u8_color(writer, cookie, val)                         LOCI_SHOW_u8 (writer, cookie, val)
#define LOCI_SHOW_u16_n_bits(writer, cookie, val)                       LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u16_src_offset(writer, cookie, val)                   LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u16_dst_offset(writer, cookie, val)                   LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u16_act_color(writer, cookie, val)                    LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u32_lmep_id(writer, cookie, val)                      LOCI_SHOW_u32(writer, cookie, val)
#define LOCI_SHOW_u64_transmit_packets(writer, cookie, val)             LOCI_SHOW_u64(writer, cookie, val)
#define LOCI_SHOW_u64_receive_packets(writer, cookie, val)              LOCI_SHOW_u64(writer, cookie, val)
#define LOCI_SHOW_u32_drop_index(writer, cookie, val)                   LOCI_SHOW_u32(writer, cookie, val)
#define LOCI_SHOW_u8_drop_type(writer, cookie, val)                     LOCI_SHOW_x8 (writer, cookie, val)
#define LOCI_SHOW_u16_ofdpa_vrf(writer, cookie, val)                    LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u8_ofdpa_traffic_class(writer, cookie, val)           LOCI_SHOW_x8 (writer, cookie, val)
#define LOCI_SHOW_u8_ofdpa_color(writer, cookie, val)                   LOCI_SHOW_x8 (writer, cookie, val)
#define LOCI_SHOW_u8_ofdpa_dei(writer, cookie, val)                     LOCI_SHOW_x8 (writer, cookie, val)
#define LOCI_SHOW_u8_ofdpa_qos_index(writer, cookie, val)               LOCI_SHOW_x8 (writer, cookie, val)
#define LOCI_SHOW_u16_ofdpa_qos_index(writer, cookie, val)              LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u32_ofdpa_lmep_id(writer, cookie, val)                LOCI_SHOW_u32(writer, cookie, val)
#define LOCI_SHOW_u8_ofdpa_mpls_ttl(writer, cookie, val)                LOCI_SHOW_x8 (writer, cookie, val)
#define LOCI_SHOW_u32_ofdpa_mpls_l2_port(writer, cookie, val)           LOCI_SHOW_u32(writer, cookie, val)
#define LOCI_SHOW_u32_ofdpa_l3_in_port(writer, cookie, val)             LOCI_SHOW_u32(writer, cookie, val)
#define LOCI_SHOW_u16_ofdpa_ovid(writer, cookie, val)                   LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u8_ofdpa_mpls_data_first_nibble(writer, cookie, val)  LOCI_SHOW_x8 (writer, cookie, val)
#define LOCI_SHOW_u16_ofdpa_mpls_ach_channel(writer, cookie, val)       LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u8_ofdpa_mpls_next_label_is_gal(writer, cookie, val)  LOCI_SHOW_x8 (writer, cookie, val)
#define LOCI_SHOW_u8_ofdpa_oam_y1731_mdl(writer, cookie, val)           LOCI_SHOW_x8 (writer, cookie, val)
#define LOCI_SHOW_u8_ofdpa_oam_y1731_opcode(writer, cookie, val)        LOCI_SHOW_x8 (writer, cookie, val)
#define LOCI_SHOW_u32_ofdpa_color_actions_index(writer, cookie, val)    LOCI_SHOW_u32(writer, cookie, val)
#define LOCI_SHOW_u64_ofdpa_txfcl(writer, cookie, val)                  LOCI_SHOW_x64(writer, cookie, val)
#define LOCI_SHOW_u64_ofdpa_rxfcl(writer, cookie, val)                  LOCI_SHOW_x64(writer, cookie, val)
#define LOCI_SHOW_u64_ofdpa_rx_timestamp(writer, cookie, val)           LOCI_SHOW_x64(writer, cookie, val)
#define LOCI_SHOW_u8_ofdpa_protection_index(writer, cookie, val)        LOCI_SHOW_u8 (writer, cookie, val)
#define LOCI_SHOW_u8_ofdpa_eth_subtype(writer, cookie, val)             LOCI_SHOW_u8 (writer, cookie, val)
#define LOCI_SHOW_u16_ofdpa_mpls_type(writer, cookie, val)              LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u8_ofdpa_allow_vlan_translation(writer, cookie, val)  LOCI_SHOW_x8 (writer, cookie, val)

#define LOCI_SHOW_u32_onf_actset_output(writer, cookie, val)            LOCI_SHOW_u32(writer, cookie, val)

#define LOCI_SHOW_u32_mod_command(writer, cookie, val)                  LOCI_SHOW_u32(writer, cookie, val)
#define LOCI_SHOW_u32_block_index(writer, cookie, val)                  LOCI_SHOW_u32(writer, cookie, val)
#define LOCI_SHOW_u64_packets(writer, cookie, val)                      LOCI_SHOW_u64(writer, cookie, val)
#define LOCI_SHOW_u64_bytes(writer, cookie, val)                        LOCI_SHOW_u64(writer, cookie, val)
#define LOCI_SHOW_u8_traffic_class(writer, cookie, val)                 LOCI_SHOW_u8(writer, cookie, val)
#define LOCI_SHOW_u64_reference_count(writer, cookie, val)              LOCI_SHOW_u64(writer, cookie, val)
#define LOCI_SHOW_u32_index(writer, cookie, val)                        LOCI_SHOW_u32(writer, cookie, val)
#define LOCI_SHOW_u8_dscp(writer, cookie, val)                          LOCI_SHOW_u8(writer, cookie, val)
#define LOCI_SHOW_u8_vlan_dei(writer, cookie, val)                      LOCI_SHOW_u8(writer, cookie, val)
#define LOCI_SHOW_u8_entry_type(writer, cookie, val)                    LOCI_SHOW_u8(writer, cookie, val)
#define LOCI_SHOW_u8_drop_status(writer, cookie, val)                   LOCI_SHOW_u8(writer, cookie, val)
#define LOCI_SHOW_u16_pm_type(writer, cookie, val)                      LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u16_mode(writer, cookie, val)                         LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u16_parameter(writer, cookie, val)                    LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u16_scheduler_level(writer, cookie, val)              LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u16_level(writer, cookie, val)                        LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u32_port(writer, cookie, val)                         LOCI_SHOW_u32(writer, cookie, val)
#define LOCI_SHOW_u16_max_rate(writer, cookie, val)                     LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u16_min_rate(writer, cookie, val)                     LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u16_meter_command(writer, cookie, val)                LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u16_meter_flags(writer, cookie, val)                  LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u16_mb_type(writer, cookie, val)                      LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u8_mode(writer, cookie, val)                          LOCI_SHOW_u8(writer, cookie, val)
#define LOCI_SHOW_u8_color_aware(writer, cookie, val)                   LOCI_SHOW_u8(writer, cookie, val)
#define LOCI_SHOW_u16_drop_type(writer, cookie, val)                    LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u16_traffic_class(writer, cookie, val)                LOCI_SHOW_u16(writer, cookie, val)
#define LOCI_SHOW_u8_pcp_dei(writer, cookie, val)                       LOCI_SHOW_u8(writer, cookie, val)
#define LOCI_SHOW_u32_value_masked(writer, cookie, val)                 LOCI_SHOW_u8(writer, cookie, val)
