...
#DELETE Policy ACL flow
curl -v -H "Content-Type: application/json" -H "Accept: application/json" -X DELETE http://$controller_ip:8080/restconf/config/opendaylight-inventory:nodes/node/$openflow_node/table/60/flow/1
