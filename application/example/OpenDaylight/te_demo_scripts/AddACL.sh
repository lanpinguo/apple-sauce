...
#PUT Policy ACL flow
curl -v -H "Content-Type: application/json" -H "Accept: application/json" -X PUT --data "@$(pwd)/../conf/te_demo/te_add_acl.json" http://$controller_ip:8080/restconf/config/opendaylight-inventory:nodes/node/$openflow_node/table/60/flow/1
